...
public class WxMpQrcodeApi extends WxMpApi {
    ...
    public WxMpQrcodeTicket createTmpTicket(String accessToken, int sceneId, Integer expireSeconds) {
        if (sceneId == 0) throw new RuntimeException("临时二维码场景值不能为0！");
        return createQrcode(accessToken,"QR_SCENE", null, sceneId, expireSeconds);
    }

    public WxMpQrcodeTicket createTmpTicket(String accessToken, String sceneStr, Integer expireSeconds) {
    ...
    public WxMpQrcodeTicket createTicket(String accessToken, int sceneId) {
    ...
    public WxMpQrcodeTicket createTicket(String accessToken, String sceneStr) {
     ...
     * @return
     */
    private WxMpQrcodeTicket createQrcode(String accessToken, String actionName, String sceneStr, Integer sceneId, Integer expireSeconds) {
    ...
    private WxMpQrcodeTicket getQrcodeTicket(String accessToken, String actionName, String sceneStr, Integer sceneId, Integer expireSeconds) {
