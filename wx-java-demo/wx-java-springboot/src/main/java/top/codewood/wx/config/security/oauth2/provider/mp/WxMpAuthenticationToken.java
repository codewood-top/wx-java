...
public class WxMpAuthenticationToken extends AbstractAuthenticationToken {
    ...
    public WxMpAuthenticationToken(String appid, String code) {
        super(null);
        this.pricipal = appid;
     ...
     */
    public WxMpAuthenticationToken(String pricipal, String credentials, Collection<? extends GrantedAuthority> authorities) {
        super(authorities);
