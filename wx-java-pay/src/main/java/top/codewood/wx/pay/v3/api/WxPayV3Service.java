...
public class WxPayV3Service {
    ...
    private String get(String url) {
        try {
            ...
            HttpResponse httpResponse = new WxPayHttpClient(wxPayConfig).v3GetWithResponse(url, token);
    ...
    private String post(String url, String data) {
        try {
            ...
            HttpResponse httpResponse = new WxPayHttpClient(wxPayConfig).v3PostWithResponse(url, data,  token);
            return verifyHttpResponse(httpResponse);
        } catch (IOException e) {
            throw new RuntimeException(e);
        }
